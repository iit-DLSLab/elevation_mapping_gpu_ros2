...
class Parameter(Serializable):
    ...
    plugin_config_file: str = "/home/ros/workspace/src/elevation_mapping_cupy/elevation_mapping_cupy/config/core/plugin_config.yaml"  # configuration file for the plugin
    weight_file: str = "/home/ros/workspace/src/elevation_mapping_cupy/elevation_mapping_cupy/config/core/weights.dat"  # weight file for traversability filter
